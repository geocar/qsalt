...
ZK pdecrypt(K x,K y,K z){K r=ktn(KG,xn);if(-1==crypto_box_curve25519xsalsa20poly1305_ref_open(kG(r),xG,xn-32,xG+(xn-32),kG(y),kG(z)))r0(r),r=ss("");else{memmove(kG(r),kG(r)+32,xn-32);r->n-=32;while(r->n&&!kG(r)[r->n-1])r->n--;}R r;} //message;senderpublic;receiversecret->text
