...
A text~.qsalt.pdecrypt[message;alice 0;bob 1]

alice:.qsalt.newkey`
bob:.qsalt.newkey`

message:.qsalt.sign[text:"this is verified";alice 1]
A text~.qsalt.verify[message;alice 0]
A not text~.qsalt.verify[0x69,message;alice 0]

secret:.qsalt.random32`
message:.qsalt.sencrypt[(.qsalt.nonce`;text:"this is also secret");secret]
A text~.qsalt.sdecrypt[message;secret]
A not text~.qsalt.sdecrypt[0x69,message;secret]
